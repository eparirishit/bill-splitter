  ...
  ({ className, ...props }, ref) => (
    ...
    >
      ...
      <rect
        ...
        stroke="hsl(var(--foreground-h) var(--foreground-s) var(--foreground-l) / 0.4)"
        fill="hsl(var(--card-h) var(--card-s) var(--card-l))"
        strokeWidth="1.5"
      />
      ...
      <line
        ...
        stroke="hsl(var(--muted-foreground-h) var(--muted-foreground-s) var(--muted-foreground-l) / 0.6)"
        strokeWidth="1.5"
      />
       <line
